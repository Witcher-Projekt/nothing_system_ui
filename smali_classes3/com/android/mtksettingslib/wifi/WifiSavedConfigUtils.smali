.class public Lcom/android/mtksettingslib/wifi/WifiSavedConfigUtils;
...
.method public static getAllConfigs(Landroid/content/Context;Landroid/net/wifi/WifiManager;)Ljava/util/List;
    ...
    invoke-direct {v3, p0, v2}, Lcom/android/mtksettingslib/wifi/AccessPoint;-><init>(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)V
    ...
    .line 60
    new-instance v2, Lcom/android/mtksettingslib/wifi/AccessPoint;

    invoke-direct {v2, p0, v1}, Lcom/android/mtksettingslib/wifi/AccessPoint;-><init>(Landroid/content/Context;Landroid/net/wifi/hotspot2/PasspointConfiguration;)V
...
.method public static getAllConfigsCount(Landroid/content/Context;Landroid/net/wifi/WifiManager;)I
    ...
    .line 78
    invoke-static {p0, p1}, Lcom/android/mtksettingslib/wifi/WifiSavedConfigUtils;->getAllConfigs(Landroid/content/Context;Landroid/net/wifi/WifiManager;)Ljava/util/List;
