...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-direct {v0, p2, v1}, Lcom/android/settingslib/fuelgauge/BatteryStatus;-><init>(Landroid/content/Intent;Z)V
    ...
    invoke-static {p1, p2}, Lcom/android/settingslib/fuelgauge/BatteryStatus;->create(Landroid/content/Context;Z)Lcom/android/settingslib/fuelgauge/BatteryStatus;
    ...
    .line 1851
    iget v4, p1, Lcom/android/keyguard/KeyguardUpdateMonitor$SimData;->phoneId:I
    ...
    .line 1852
    :goto_0
    iget v4, p1, Lcom/android/keyguard/KeyguardUpdateMonitor$SimData;->simState:I
    ...
    const-string/jumbo p2, "when sim state and telephonymanager state different will return args.simState"
    ...
    iget v2, p1, Lcom/android/keyguard/KeyguardUpdateMonitor$SimData;->subId:I

    invoke-virtual {p2, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object p2

    const-string v2, ", args.simState = "
    ...
    .line 1866
    const-string p2, "com.mediatek.phone.ACTION_UNLOCK_SIM_LOCK"
    ...
    .line 1868
    const-string p2, "ACTION_UNLOCK_SIM_LOCK, set sim state as UNKNOWN"
    ...
    invoke-static {p2}, Lcom/android/keyguard/KeyguardUpdateMonitor;->-$$Nest$fgetmSimStateOfPhoneId(Lcom/android/keyguard/KeyguardUpdateMonitor;)Ljava/util/HashMap;

    move-result-object p2

    iget v0, p1, Lcom/android/keyguard/KeyguardUpdateMonitor$SimData;->phoneId:I
    ...
    invoke-static {p0, p1}, Lcom/android/keyguard/KeyguardUpdateMonitor;->-$$Nest$mproceedToHandleSimStateChanged(Lcom/android/keyguard/KeyguardUpdateMonitor;Lcom/android/keyguard/KeyguardUpdateMonitor$SimData;)V
    ...
    invoke-static {p2}, Lcom/android/keyguard/KeyguardUpdateMonitor;->-$$Nest$fgetmLogger(Lcom/android/keyguard/KeyguardUpdateMonitor;)Lcom/android/keyguard/logging/KeyguardUpdateMonitorLogger;

    move-result-object p2

    new-instance v0, Ljava/lang/StringBuilder;

    const-string v1, "Receive ACTION_AIRPLANE_MODE_CHANGED, state = "
    ...
    invoke-virtual {p2, v0}, Lcom/android/keyguard/logging/KeyguardUpdateMonitorLogger;->d(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v0, p1, p2}, Lcom/android/keyguard/logging/KeyguardUpdateMonitorLogger;->logServiceStateIntent(Ljava/lang/String;Landroid/telephony/ServiceState;I)V
    ...
    invoke-virtual {p2, v0}, Lcom/android/keyguard/logging/KeyguardUpdateMonitorLogger;->v(Ljava/lang/String;)V
