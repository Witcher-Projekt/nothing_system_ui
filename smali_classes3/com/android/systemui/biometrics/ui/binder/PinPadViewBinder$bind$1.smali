...
.method public onBackspaceClick()V
    ...
    .line 47
    iget-object p0, p0, Lcom/android/systemui/biometrics/ui/binder/PinPadViewBinder$bind$1;->$passwordField:Landroid/widget/ImeAwareEditText;
    ...
    .line 45
    invoke-interface {v1, v2, p0}, Landroid/text/Editable;->delete(II)Landroid/text/Editable;
...
.method public onDigitKeyClick(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Landroid/widget/ImeAwareEditText;->append(Ljava/lang/CharSequence;)V
...
.method public onEnterKeyClick()V
    ...
    .line 57
    invoke-virtual {p0, v8}, Landroid/widget/ImeAwareEditText;->dispatchKeyEvent(Landroid/view/KeyEvent;)Z
