...
.method public constructor <init>(Lcom/android/systemui/bouncer/shared/flag/ComposeBouncerFlags;Ldagger/Lazy;Ldagger/Lazy;)V
    ...
    const-string v0, "legacyBouncerDependencies"
...
.method public final bind(Landroid/view/ViewGroup;)V
    ...
    .line 65
    sget-object v0, Lcom/android/systemui/bouncer/ui/binder/ComposeBouncerViewBinder;->INSTANCE:Lcom/android/systemui/bouncer/ui/binder/ComposeBouncerViewBinder;

    .line 67
    invoke-virtual {p0}, Lcom/android/systemui/bouncer/ui/binder/ComposeBouncerDependencies;->getLegacyInteractor()Lcom/android/systemui/bouncer/domain/interactor/PrimaryBouncerInteractor;

    move-result-object v2

    .line 68
    invoke-virtual {p0}, Lcom/android/systemui/bouncer/ui/binder/ComposeBouncerDependencies;->getViewModel()Lcom/android/systemui/bouncer/ui/viewmodel/BouncerViewModel;

    move-result-object v3

    .line 69
    invoke-virtual {p0}, Lcom/android/systemui/bouncer/ui/binder/ComposeBouncerDependencies;->getDialogFactory()Lcom/android/systemui/bouncer/ui/BouncerDialogFactory;

    move-result-object v4

    .line 70
    invoke-virtual {p0}, Lcom/android/systemui/bouncer/ui/binder/ComposeBouncerDependencies;->getAuthenticationInteractor()Lcom/android/systemui/authentication/domain/interactor/AuthenticationInteractor;

    move-result-object v5

    .line 71
    invoke-virtual {p0}, Lcom/android/systemui/bouncer/ui/binder/ComposeBouncerDependencies;->getSelectedUserInteractor()Lcom/android/systemui/user/domain/interactor/SelectedUserInteractor;

    move-result-object v6

    .line 72
    invoke-virtual {p0}, Lcom/android/systemui/bouncer/ui/binder/ComposeBouncerDependencies;->getViewMediatorCallback()Lcom/android/keyguard/ViewMediatorCallback;
    ...
    .line 78
    invoke-virtual {p0}, Lcom/android/systemui/bouncer/ui/binder/LegacyBouncerDependencies;->getViewModel()Lcom/android/systemui/bouncer/ui/viewmodel/KeyguardBouncerViewModel;

    move-result-object v1

    .line 79
    invoke-virtual {p0}, Lcom/android/systemui/bouncer/ui/binder/LegacyBouncerDependencies;->getPrimaryBouncerToGoneTransitionViewModel()Lcom/android/systemui/keyguard/ui/viewmodel/PrimaryBouncerToGoneTransitionViewModel;

    move-result-object v2

    .line 80
    invoke-virtual {p0}, Lcom/android/systemui/bouncer/ui/binder/LegacyBouncerDependencies;->getComponentFactory()Lcom/android/keyguard/dagger/KeyguardBouncerComponent$Factory;

    move-result-object v3

    .line 81
    invoke-virtual {p0}, Lcom/android/systemui/bouncer/ui/binder/LegacyBouncerDependencies;->getMessageAreaControllerFactory()Lcom/android/keyguard/KeyguardMessageAreaController$Factory;

    move-result-object v4

    .line 82
    invoke-virtual {p0}, Lcom/android/systemui/bouncer/ui/binder/LegacyBouncerDependencies;->getBouncerMessageInteractor()Lcom/android/systemui/bouncer/domain/interactor/BouncerMessageInteractor;

    move-result-object v5

    .line 83
    invoke-virtual {p0}, Lcom/android/systemui/bouncer/ui/binder/LegacyBouncerDependencies;->getBouncerLogger()Lcom/android/systemui/log/BouncerLogger;

    move-result-object v6

    .line 84
    invoke-virtual {p0}, Lcom/android/systemui/bouncer/ui/binder/LegacyBouncerDependencies;->getSelectedUserInteractor()Lcom/android/systemui/user/domain/interactor/SelectedUserInteractor;
