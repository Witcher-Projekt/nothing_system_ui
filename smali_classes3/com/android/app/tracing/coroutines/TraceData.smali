...
.method private final strictModeCheck()V
    ...
    const-string v0, "TraceData should only be accessed using the ThreadLocal: CURRENT_TRACE.get(). Accessing TraceData by other means, such as through the TraceContextElement\'s property may lead to concurrent modification."
...
.method public final beginAllOnThread$frameworks__libs__systemui__tracinglib__core__android_common__tracinglib_platform()V
    ...
    invoke-virtual {v0, p0}, Lcom/android/app/tracing/coroutines/TraceCountThreadLocal;->set(Ljava/lang/Object;)V
...
.method public final endAllOnThread$frameworks__libs__systemui__tracinglib__core__android_common__tracinglib_platform()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/app/tracing/coroutines/TraceCountThreadLocal;->set(Ljava/lang/Object;)V
...
.method public final endSpan()V
    ...
    .line 102
    :cond_0
    sget-boolean p0, Lcom/android/app/tracing/coroutines/TraceData;->strictModeForTesting:Z
    ...
    const-string v0, "TraceData#endSpan called when there were no active trace sections."
