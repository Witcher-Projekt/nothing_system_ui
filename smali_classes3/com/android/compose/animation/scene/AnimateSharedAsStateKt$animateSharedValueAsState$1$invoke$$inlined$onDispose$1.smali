...
.method public dispose()V
    ...
    .line 498
    iget-object v0, p0, Lcom/android/compose/animation/scene/AnimateSharedAsStateKt$animateSharedValueAsState$1$invoke$$inlined$onDispose$1;->$targetValues$inlined:Landroidx/compose/runtime/snapshots/SnapshotStateMap;

    iget-object v1, p0, Lcom/android/compose/animation/scene/AnimateSharedAsStateKt$animateSharedValueAsState$1$invoke$$inlined$onDispose$1;->$scene$inlined:Lcom/android/compose/animation/scene/SceneKey;
    ...
    iget-object v0, p0, Lcom/android/compose/animation/scene/AnimateSharedAsStateKt$animateSharedValueAsState$1$invoke$$inlined$onDispose$1;->$valueMap$inlined:Ljava/util/Map;

    iget-object v1, p0, Lcom/android/compose/animation/scene/AnimateSharedAsStateKt$animateSharedValueAsState$1$invoke$$inlined$onDispose$1;->$element$inlined:Lcom/android/compose/animation/scene/ElementKey;

    invoke-interface {v0, v1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    iget-object v1, p0, Lcom/android/compose/animation/scene/AnimateSharedAsStateKt$animateSharedValueAsState$1$invoke$$inlined$onDispose$1;->$sharedValue$inlined:Lcom/android/compose/animation/scene/SharedValue;
    ...
    iget-object v0, p0, Lcom/android/compose/animation/scene/AnimateSharedAsStateKt$animateSharedValueAsState$1$invoke$$inlined$onDispose$1;->$layoutImpl$inlined:Lcom/android/compose/animation/scene/SceneTransitionLayoutImpl;

    invoke-virtual {v0}, Lcom/android/compose/animation/scene/SceneTransitionLayoutImpl;->getSharedValues$scene_release()Ljava/util/Map;

    move-result-object v0

    iget-object v1, p0, Lcom/android/compose/animation/scene/AnimateSharedAsStateKt$animateSharedValueAsState$1$invoke$$inlined$onDispose$1;->$key$inlined:Lcom/android/compose/animation/scene/ValueKey;
    ...
    iget-object p0, p0, Lcom/android/compose/animation/scene/AnimateSharedAsStateKt$animateSharedValueAsState$1$invoke$$inlined$onDispose$1;->$key$inlined:Lcom/android/compose/animation/scene/ValueKey;
