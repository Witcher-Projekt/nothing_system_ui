...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/appops/AppOpsController;Lcom/android/systemui/util/DeviceConfigProxy;Landroid/os/Looper;Landroid/os/Handler;Lcom/android/systemui/broadcast/BroadcastDispatcher;Lcom/android/systemui/BootCompleteCache;Lcom/android/systemui/settings/UserTracker;Landroid/content/pm/PackageManager;Lcom/android/internal/logging/UiEventLogger;Lcom/android/systemui/util/settings/SecureSettings;)V
    ...
    .line 108
    invoke-direct {p0}, Lcom/android/systemui/statusbar/policy/LocationControllerImpl;->getShowSystemFlag()Z
    ...
    invoke-interface {p11, p7, p4, p8}, Lcom/android/systemui/util/settings/SecureSettings;->registerContentObserverForUserSync(Ljava/lang/String;Landroid/database/ContentObserver;I)V
    ...
    invoke-direct {p4, p5}, Lcom/android/systemui/statusbar/policy/LocationControllerImpl$$ExternalSyntheticLambda1;-><init>(Landroid/os/Handler;)V

    new-instance p7, Lcom/android/systemui/statusbar/policy/LocationControllerImpl$$ExternalSyntheticLambda2;

    invoke-direct {p7, p0}, Lcom/android/systemui/statusbar/policy/LocationControllerImpl$$ExternalSyntheticLambda2;-><init>(Lcom/android/systemui/statusbar/policy/LocationControllerImpl;)V

    .line 122
    const-string p8, "privacy"
    ...
    .line 142
    new-instance p1, Lcom/android/systemui/statusbar/policy/LocationControllerImpl$$ExternalSyntheticLambda3;

    invoke-direct {p1, p0}, Lcom/android/systemui/statusbar/policy/LocationControllerImpl$$ExternalSyntheticLambda3;-><init>(Lcom/android/systemui/statusbar/policy/LocationControllerImpl;)V
...
.method private getShowSystemFlag()Z
    ...
    const-string v0, "location_indicators_show_system"
...
.method private isSystemApp(Ljava/util/List;Lcom/android/systemui/appops/AppOpItem;)Z
    ...
    .line 316
    invoke-static {p0, v0, v2, v1, p2}, Landroid/content/PermissionChecker;->checkPermissionForPreflight(Landroid/content/Context;Ljava/lang/String;IILjava/lang/String;)I
...
.method protected areActiveLocationRequests()V
    ...
    invoke-direct {p0, v5, v11}, Lcom/android/systemui/statusbar/policy/LocationControllerImpl;->isSystemApp(Ljava/util/List;Lcom/android/systemui/appops/AppOpItem;)Z
