...
# direct methods
.method public static synthetic $r8$lambda$e4mxRfT0Hw5cSPQ-5xg0Ir7-MhU(Lcom/android/systemui/statusbar/chips/screenrecord/ui/view/EndScreenRecordingDialogDelegate;Landroid/content/DialogInterface;I)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/android/systemui/statusbar/chips/screenrecord/ui/view/EndScreenRecordingDialogDelegate;->beforeCreate$lambda$1$lambda$0(Lcom/android/systemui/statusbar/chips/screenrecord/ui/view/EndScreenRecordingDialogDelegate;Landroid/content/DialogInterface;I)V
...
.method private static final beforeCreate$lambda$1$lambda$0(Lcom/android/systemui/statusbar/chips/screenrecord/ui/view/EndScreenRecordingDialogDelegate;Landroid/content/DialogInterface;I)V
    .locals 0
...
.method public bridge synthetic beforeCreate(Landroid/app/Dialog;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/systemui/statusbar/chips/screenrecord/ui/view/EndScreenRecordingDialogDelegate;->beforeCreate(Lcom/android/systemui/statusbar/phone/SystemUIDialog;Landroid/os/Bundle;)V
...
.method public beforeCreate(Lcom/android/systemui/statusbar/phone/SystemUIDialog;Landroid/os/Bundle;)V
    ...
    .line 39
    sget-object p2, Lcom/android/systemui/statusbar/chips/screenrecord/ui/viewmodel/ScreenRecordChipViewModel;->Companion:Lcom/android/systemui/statusbar/chips/screenrecord/ui/viewmodel/ScreenRecordChipViewModel$Companion;

    invoke-virtual {p2}, Lcom/android/systemui/statusbar/chips/screenrecord/ui/viewmodel/ScreenRecordChipViewModel$Companion;->getICON()I
    ...
    .line 40
    sget p2, Lcom/android/systemui/res/R$string;->screenrecord_stop_dialog_title:I

    invoke-virtual {p1, p2}, Lcom/android/systemui/statusbar/phone/SystemUIDialog;->setTitle(I)V

    .line 42
    iget-object p2, p0, Lcom/android/systemui/statusbar/chips/screenrecord/ui/view/EndScreenRecordingDialogDelegate;->endMediaProjectionDialogHelper:Lcom/android/systemui/statusbar/chips/mediaprojection/ui/view/EndMediaProjectionDialogHelper;
    ...
    .line 44
    sget v1, Lcom/android/systemui/res/R$string;->screenrecord_stop_dialog_message:I

    .line 45
    sget v2, Lcom/android/systemui/res/R$string;->screenrecord_stop_dialog_message_specific_app:I

    .line 42
    invoke-virtual {p2, v0, v1, v2}, Lcom/android/systemui/statusbar/chips/mediaprojection/ui/view/EndMediaProjectionDialogHelper;->getDialogMessage(Landroid/app/ActivityManager$RunningTaskInfo;II)Ljava/lang/CharSequence;
    ...
    .line 51
    sget p2, Lcom/android/systemui/res/R$string;->screenrecord_stop_dialog_button:I

    new-instance v0, Lcom/android/systemui/statusbar/chips/screenrecord/ui/view/EndScreenRecordingDialogDelegate$$ExternalSyntheticLambda0;

    invoke-direct {v0, p0}, Lcom/android/systemui/statusbar/chips/screenrecord/ui/view/EndScreenRecordingDialogDelegate$$ExternalSyntheticLambda0;-><init>(Lcom/android/systemui/statusbar/chips/screenrecord/ui/view/EndScreenRecordingDialogDelegate;)V
