...
.method public final create(Lcom/android/systemui/qs/pipeline/shared/TileSpec;Lcom/android/systemui/qs/tiles/base/interactor/QSTileUserActionInteractor;Lcom/android/systemui/qs/tiles/base/interactor/QSTileDataInteractor;Lcom/android/systemui/qs/tiles/base/interactor/QSTileDataToStateMapper;)Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelImpl;
    ...
    invoke-interface {v6, v5}, Lcom/android/systemui/qs/tiles/viewmodel/QSTileConfigProvider;->getConfig(Ljava/lang/String;)Lcom/android/systemui/qs/tiles/viewmodel/QSTileConfig;

    move-result-object v6

    .line 129
    new-instance v5, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelFactory$Static$create$1;

    invoke-direct {v5, v1}, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelFactory$Static$create$1;-><init>(Lcom/android/systemui/qs/tiles/base/interactor/QSTileUserActionInteractor;)V
    ...
    .line 130
    new-instance v1, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelFactory$Static$create$2;

    invoke-direct {v1, v2}, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelFactory$Static$create$2;-><init>(Lcom/android/systemui/qs/tiles/base/interactor/QSTileDataInteractor;)V
    ...
    .line 131
    new-instance v1, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelFactory$Static$create$3;

    invoke-direct {v1, v3}, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelFactory$Static$create$3;-><init>(Lcom/android/systemui/qs/tiles/base/interactor/QSTileDataToStateMapper;)V
    ...
    .line 132
    iget-object v10, v0, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelFactory$Static;->disabledByPolicyInteractor:Lcom/android/systemui/qs/tiles/base/interactor/DisabledByPolicyInteractor;

    .line 133
    iget-object v11, v0, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelFactory$Static;->userRepository:Lcom/android/systemui/user/data/repository/UserRepository;

    .line 134
    iget-object v12, v0, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelFactory$Static;->falsingManager:Lcom/android/systemui/plugins/FalsingManager;

    .line 135
    iget-object v13, v0, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelFactory$Static;->qsTileAnalytics:Lcom/android/systemui/qs/tiles/base/analytics/QSTileAnalytics;

    .line 136
    iget-object v14, v0, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelFactory$Static;->qsTileLogger:Lcom/android/systemui/qs/tiles/base/logging/QSTileLogger;

    .line 137
    iget-object v15, v0, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelFactory$Static;->systemClock:Lcom/android/systemui/util/time/SystemClock;
    ...
    .line 139
    iget-object v0, v0, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelFactory$Static;->coroutineScopeFactory:Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileCoroutineScopeFactory;

    invoke-virtual {v0}, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileCoroutineScopeFactory;->create()Lkotlinx/coroutines/CoroutineScope;
    ...
    .line 127
    invoke-direct/range {v5 .. v17}, Lcom/android/systemui/qs/tiles/base/viewmodel/QSTileViewModelImpl;-><init>(Lcom/android/systemui/qs/tiles/viewmodel/QSTileConfig;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Lcom/android/systemui/qs/tiles/base/interactor/DisabledByPolicyInteractor;Lcom/android/systemui/user/data/repository/UserRepository;Lcom/android/systemui/plugins/FalsingManager;Lcom/android/systemui/qs/tiles/base/analytics/QSTileAnalytics;Lcom/android/systemui/qs/tiles/base/logging/QSTileLogger;Lcom/android/systemui/util/time/SystemClock;Lkotlinx/coroutines/CoroutineDispatcher;Lkotlinx/coroutines/CoroutineScope;)V
