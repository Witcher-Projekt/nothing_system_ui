...
# direct methods
.method public static synthetic $r8$lambda$hp9tpX0y4iNriUlgEzljNfKqM5M(Ljava/lang/Object;)Z
    .locals 0
...
.method public static augmentTileFromNotification(Landroid/content/Context;Landroid/app/people/PeopleSpaceTile;Lcom/android/systemui/people/widget/PeopleTileKey;Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;ILjava/util/Optional;Landroid/app/backup/BackupManager;)Landroid/app/people/PeopleSpaceTile;
    ...
    .line 271
    sget p1, Lcom/android/systemui/res/R$string;->missed_call:I
...
.method public static getNotificationsByUri(Landroid/content/pm/PackageManager;Ljava/lang/String;Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/systemui/people/PeopleSpaceUtils$$ExternalSyntheticLambda8;-><init>(Landroid/content/pm/PackageManager;Ljava/lang/String;)V
...
.method public static getSortedTiles(Landroid/app/people/IPeopleManager;Landroid/content/pm/LauncherApps;Landroid/os/UserManager;Ljava/util/stream/Stream;)Ljava/util/List;
    ...
    invoke-direct {v0, p2}, Lcom/android/systemui/people/PeopleSpaceUtils$$ExternalSyntheticLambda2;-><init>(Landroid/os/UserManager;)V
    ...
    new-instance p2, Lcom/android/systemui/people/PeopleSpaceUtils$$ExternalSyntheticLambda4;

    invoke-direct {p2}, Lcom/android/systemui/people/PeopleSpaceUtils$$ExternalSyntheticLambda4;-><init>()V
    ...
    invoke-direct {p2, p0}, Lcom/android/systemui/people/PeopleSpaceUtils$$ExternalSyntheticLambda5;-><init>(Landroid/app/people/IPeopleManager;)V
...
.method private static hasBirthdayStatus(Landroid/app/people/PeopleSpaceTile;Landroid/content/Context;)Z
    ...
    sget v0, Lcom/android/systemui/res/R$string;->birthday_status:I
