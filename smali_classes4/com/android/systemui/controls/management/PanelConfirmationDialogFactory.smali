...
# direct methods
.method public static synthetic $r8$lambda$UqP5VQHDzuwL6HJ8U5u-XPlDubg(Ljava/util/function/Consumer;Landroid/content/DialogInterface;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/systemui/controls/management/PanelConfirmationDialogFactory;->createConfirmationDialog$lambda$2$lambda$1(Ljava/util/function/Consumer;Landroid/content/DialogInterface;)V

    return-void
.end method

.method public static synthetic $r8$lambda$ePmlxdJ--STrhlPW6XFELEvJbWc(Ljava/util/function/Consumer;Landroid/content/DialogInterface;I)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/android/systemui/controls/management/PanelConfirmationDialogFactory;->createConfirmationDialog$lambda$0(Ljava/util/function/Consumer;Landroid/content/DialogInterface;I)V
...
.method private static final createConfirmationDialog$lambda$0(Ljava/util/function/Consumer;Landroid/content/DialogInterface;I)V
    .locals 0
...
.method private static final createConfirmationDialog$lambda$2$lambda$1(Ljava/util/function/Consumer;Landroid/content/DialogInterface;)V
    .locals 0
...
.method public final createConfirmationDialog(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/util/function/Consumer;)Landroid/app/Dialog;
    ...
    .line 46
    new-instance v0, Lcom/android/systemui/controls/management/PanelConfirmationDialogFactory$$ExternalSyntheticLambda0;

    invoke-direct {v0, p3}, Lcom/android/systemui/controls/management/PanelConfirmationDialogFactory$$ExternalSyntheticLambda0;-><init>(Ljava/util/function/Consumer;)V

    .line 50
    iget-object p0, p0, Lcom/android/systemui/controls/management/PanelConfirmationDialogFactory;->dialogFactory:Lcom/android/systemui/statusbar/phone/SystemUIDialog$Factory;
    ...
    sget v1, Lcom/android/systemui/res/R$string;->controls_panel_authorization_title:I
    ...
    sget v1, Lcom/android/systemui/res/R$string;->controls_panel_authorization:I
    ...
    .line 54
    new-instance p1, Lcom/android/systemui/controls/management/PanelConfirmationDialogFactory$$ExternalSyntheticLambda1;

    invoke-direct {p1, p3}, Lcom/android/systemui/controls/management/PanelConfirmationDialogFactory$$ExternalSyntheticLambda1;-><init>(Ljava/util/function/Consumer;)V
    ...
    .line 55
    sget p1, Lcom/android/systemui/res/R$string;->controls_dialog_ok:I
