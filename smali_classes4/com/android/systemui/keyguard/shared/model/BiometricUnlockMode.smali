...
.method static constructor <clinit>()V
    ...
    const-string v2, "WAKE_AND_UNLOCK_PULSING"

    const/4 v3, 0x2

    invoke-direct {v1, v2, v3}, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;->WAKE_AND_UNLOCK_PULSING:Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;

    .line 47
    new-instance v2, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;

    const-string v3, "SHOW_BOUNCER"

    const/4 v4, 0x3

    invoke-direct {v2, v3, v4}, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;->SHOW_BOUNCER:Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;

    .line 51
    new-instance v2, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;

    const-string v3, "ONLY_WAKE"

    const/4 v4, 0x4

    invoke-direct {v2, v3, v4}, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;->ONLY_WAKE:Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;

    .line 56
    new-instance v2, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;

    const-string v3, "UNLOCK_COLLAPSING"

    const/4 v4, 0x5

    invoke-direct {v2, v3, v4}, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;->UNLOCK_COLLAPSING:Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;

    .line 58
    new-instance v3, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;

    const-string v4, "DISMISS_BOUNCER"

    const/4 v5, 0x6

    invoke-direct {v3, v4, v5}, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;->DISMISS_BOUNCER:Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;

    .line 60
    new-instance v4, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;

    const-string v5, "WAKE_AND_UNLOCK_FROM_DREAM"

    const/4 v6, 0x7

    invoke-direct {v4, v5, v6}, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;->WAKE_AND_UNLOCK_FROM_DREAM:Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;
    ...
    sput-object v5, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;->$VALUES:[Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;
    ...
    sput-object v5, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;->$ENTRIES:Lkotlin/enums/EnumEntries;

    new-instance v5, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode$Companion;

    const/4 v6, 0x0

    invoke-direct {v5, v6}, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v5, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;->Companion:Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode$Companion;

    .line 64
    filled-new-array {v0, v4, v1}, [Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;
    ...
    sput-object v5, Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;->wakeAndUnlockModes:Ljava/util/Set;

    .line 71
    filled-new-array {v0, v1, v2, v4, v3}, [Lcom/android/systemui/keyguard/shared/model/BiometricUnlockMode;
