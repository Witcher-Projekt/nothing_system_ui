...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget p2, v0, Lcom/android/systemui/keyguard/domain/interactor/KeyguardInteractor$_nonSplitShadeNotifciationPlaceholderBounds$lambda$1$$inlined$map$1$2$1;->label:I

    sub-int/2addr p2, v2

    iput p2, v0, Lcom/android/systemui/keyguard/domain/interactor/KeyguardInteractor$_nonSplitShadeNotifciationPlaceholderBounds$lambda$1$$inlined$map$1$2$1;->label:I
    ...
    .line 49
    iget-object p2, p0, Lcom/android/systemui/keyguard/domain/interactor/KeyguardInteractor$_nonSplitShadeNotifciationPlaceholderBounds$lambda$1$$inlined$map$1$2;->$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .line 220
    iget-object v2, p0, Lcom/android/systemui/keyguard/domain/interactor/KeyguardInteractor$_nonSplitShadeNotifciationPlaceholderBounds$lambda$1$$inlined$map$1$2;->$lastChangeStep$inlined:Lcom/android/systemui/keyguard/shared/model/TransitionStep;

    invoke-virtual {v2}, Lcom/android/systemui/keyguard/shared/model/TransitionStep;->getValue()F
    ...
    .line 228
    iget-object v5, p0, Lcom/android/systemui/keyguard/domain/interactor/KeyguardInteractor$_nonSplitShadeNotifciationPlaceholderBounds$lambda$1$$inlined$map$1$2;->$oldBounds$inlined:Lcom/android/systemui/common/shared/model/NotificationContainerBounds;

    invoke-virtual {v5}, Lcom/android/systemui/common/shared/model/NotificationContainerBounds;->getTop()F

    move-result v5

    iget-object v6, p0, Lcom/android/systemui/keyguard/domain/interactor/KeyguardInteractor$_nonSplitShadeNotifciationPlaceholderBounds$lambda$1$$inlined$map$1$2;->$newBounds$inlined:Lcom/android/systemui/common/shared/model/NotificationContainerBounds;

    invoke-virtual {v6}, Lcom/android/systemui/common/shared/model/NotificationContainerBounds;->getTop()F

    move-result v6

    invoke-static {v5, v6, v4}, Lcom/android/systemui/statusbar/notification/NotificationUtils;->interpolate(FFF)F
    ...
    invoke-virtual {v5}, Lcom/android/systemui/common/shared/model/NotificationContainerBounds;->getBottom()F

    move-result v5

    .line 232
    iget-object p0, p0, Lcom/android/systemui/keyguard/domain/interactor/KeyguardInteractor$_nonSplitShadeNotifciationPlaceholderBounds$lambda$1$$inlined$map$1$2;->$newBounds$inlined:Lcom/android/systemui/common/shared/model/NotificationContainerBounds;

    invoke-virtual {p0}, Lcom/android/systemui/common/shared/model/NotificationContainerBounds;->getBottom()F
    ...
    .line 230
    invoke-static {v5, p0, p1}, Lcom/android/systemui/statusbar/notification/NotificationUtils;->interpolate(FFF)F
    ...
    invoke-direct/range {v7 .. v12}, Lcom/android/systemui/common/shared/model/NotificationContainerBounds;-><init>(FFZILkotlin/jvm/internal/DefaultConstructorMarker;)V
