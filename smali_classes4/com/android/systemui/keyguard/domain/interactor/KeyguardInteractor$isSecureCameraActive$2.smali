...
.method public final invoke()Lkotlinx/coroutines/flow/Flow;
    ...
    invoke-virtual {p0}, Lcom/android/systemui/keyguard/domain/interactor/KeyguardInteractor;->getOnCameraLaunchDetected()Lkotlinx/coroutines/flow/Flow;

    move-result-object p0

    .line 301
    new-instance v2, Lcom/android/systemui/keyguard/domain/interactor/KeyguardInteractor$isSecureCameraActive$2$1;

    const/4 v3, 0x0

    invoke-direct {v2, v3}, Lcom/android/systemui/keyguard/domain/interactor/KeyguardInteractor$isSecureCameraActive$2$1;-><init>(Lkotlin/coroutines/Continuation;)V
    ...
    invoke-direct {v0, v3}, Lcom/android/systemui/keyguard/domain/interactor/KeyguardInteractor$isSecureCameraActive$2$2;-><init>(Lkotlin/coroutines/Continuation;)V
