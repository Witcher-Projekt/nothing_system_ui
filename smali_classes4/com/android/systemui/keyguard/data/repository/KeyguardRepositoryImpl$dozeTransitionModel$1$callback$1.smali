...
.method public onDozeTransition(Lcom/android/systemui/doze/DozeMachine$State;Lcom/android/systemui/doze/DozeMachine$State;)V
    ...
    .line 539
    invoke-direct {v2, p1, p0}, Lcom/android/systemui/keyguard/shared/model/DozeTransitionModel;-><init>(Lcom/android/systemui/keyguard/shared/model/DozeStateModel;Lcom/android/systemui/keyguard/shared/model/DozeStateModel;)V

    .line 543
    const-string p0, "KeyguardRepositoryImpl"

    .line 544
    const-string p1, "doze transition model"

    .line 538
    invoke-virtual {v0, v1, v2, p0, p1}, Lcom/android/systemui/common/coroutine/ChannelExt;->trySendWithFailureLogging(Lkotlinx/coroutines/channels/SendChannel;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
