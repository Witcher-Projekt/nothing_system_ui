...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 215
    iget-object v4, p0, Lcom/android/systemui/keyguard/data/repository/StrongAuthTracker$special$$inlined$flatMapLatest$1;->this$0:Lcom/android/systemui/keyguard/data/repository/StrongAuthTracker;

    invoke-static {v4}, Lcom/android/systemui/keyguard/data/repository/StrongAuthTracker;->access$get_authFlags$p(Lcom/android/systemui/keyguard/data/repository/StrongAuthTracker;)Lkotlinx/coroutines/flow/MutableStateFlow;
    ...
    iget-object v6, p0, Lcom/android/systemui/keyguard/data/repository/StrongAuthTracker$special$$inlined$flatMapLatest$1;->this$0:Lcom/android/systemui/keyguard/data/repository/StrongAuthTracker;

    invoke-direct {v5, v4, v1, v6}, Lcom/android/systemui/keyguard/data/repository/StrongAuthTracker$currentUserAuthFlags$lambda$2$$inlined$map$1;-><init>(Lkotlinx/coroutines/flow/Flow;ILcom/android/systemui/keyguard/data/repository/StrongAuthTracker;)V

    check-cast v5, Lkotlinx/coroutines/flow/Flow;

    .line 222
    new-instance v4, Lcom/android/systemui/keyguard/data/repository/StrongAuthTracker$currentUserAuthFlags$1$2;

    const/4 v6, 0x0

    invoke-direct {v4, v6}, Lcom/android/systemui/keyguard/data/repository/StrongAuthTracker$currentUserAuthFlags$1$2;-><init>(Lkotlin/coroutines/Continuation;)V

    check-cast v4, Lkotlin/jvm/functions/Function2;

    invoke-static {v5, v4}, Lkotlinx/coroutines/flow/FlowKt;->onEach(Lkotlinx/coroutines/flow/Flow;Lkotlin/jvm/functions/Function2;)Lkotlinx/coroutines/flow/Flow;

    move-result-object v4

    .line 223
    new-instance v5, Lcom/android/systemui/keyguard/data/repository/StrongAuthTracker$currentUserAuthFlags$1$3;

    iget-object v7, p0, Lcom/android/systemui/keyguard/data/repository/StrongAuthTracker$special$$inlined$flatMapLatest$1;->this$0:Lcom/android/systemui/keyguard/data/repository/StrongAuthTracker;

    invoke-direct {v5, v1, v7, v6}, Lcom/android/systemui/keyguard/data/repository/StrongAuthTracker$currentUserAuthFlags$1$3;-><init>(ILcom/android/systemui/keyguard/data/repository/StrongAuthTracker;Lkotlin/coroutines/Continuation;)V
