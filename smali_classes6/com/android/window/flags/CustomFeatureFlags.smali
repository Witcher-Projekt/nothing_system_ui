...
.method public constructor <init>(Ljava/util/function/BiPredicate;)V
    ...
    const-string v104, "com.android.window.flags.window_token_config_thread_safe"
    ...
    const-string v61, "com.android.window.flags.explicit_refresh_rate_hints"

    const-string v62, "com.android.window.flags.fifo_priority_for_major_ui_processes"

    const-string v63, "com.android.window.flags.fix_no_container_update_without_resize"

    const-string v64, "com.android.window.flags.fix_pip_restore_to_overlay"

    const-string v65, "com.android.window.flags.fullscreen_dim_flag"

    const-string v66, "com.android.window.flags.get_dimmer_on_closing"

    const-string v67, "com.android.window.flags.immersive_app_repositioning"

    const-string v68, "com.android.window.flags.insets_control_changed_item"

    const-string v69, "com.android.window.flags.insets_control_seq"

    const-string v70, "com.android.window.flags.insets_decoupled_configuration"

    const-string v71, "com.android.window.flags.introduce_smoother_dimmer"
    ...
    const-string v85, "com.android.window.flags.screen_recording_callbacks"

    const-string v86, "com.android.window.flags.sdk_desired_present_time"

    const-string v87, "com.android.window.flags.secure_window_state"

    const-string v88, "com.android.window.flags.set_sc_properties_in_client"

    const-string v89, "com.android.window.flags.skip_sleeping_when_switching_display"

    const-string v90, "com.android.window.flags.supports_multi_instance_system_ui"

    const-string v91, "com.android.window.flags.surface_control_input_receiver"

    const-string v92, "com.android.window.flags.surface_trusted_overlay"

    const-string v93, "com.android.window.flags.sync_screen_capture"

    const-string v94, "com.android.window.flags.task_fragment_system_organizer_flag"

    const-string v95, "com.android.window.flags.transit_ready_tracking"

    const-string v96, "com.android.window.flags.trusted_presentation_listener_for_window"

    const-string v97, "com.android.window.flags.untrusted_embedding_any_app_permission"

    const-string v98, "com.android.window.flags.untrusted_embedding_state_sharing"

    const-string v99, "com.android.window.flags.use_window_original_touchable_region_when_magnification_recompute_bounds"

    const-string v100, "com.android.window.flags.user_min_aspect_ratio_app_default"

    const-string v101, "com.android.window.flags.wait_for_transition_on_display_switch"

    const-string v102, "com.android.window.flags.wallpaper_offset_async"

    const-string v103, "com.android.window.flags.window_session_relayout_info"

    filled-new-array/range {v2 .. v105}, [Ljava/lang/String;
...
.method public getFlagNames()Ljava/util/List;
    ...
    .line 759
    const-string v101, "com.android.window.flags.window_session_relayout_info"

    const-string v102, "com.android.window.flags.window_token_config_thread_safe"
    ...
    const-string v59, "com.android.window.flags.explicit_refresh_rate_hints"

    const-string v60, "com.android.window.flags.fifo_priority_for_major_ui_processes"

    const-string v61, "com.android.window.flags.fix_no_container_update_without_resize"

    const-string v62, "com.android.window.flags.fix_pip_restore_to_overlay"

    const-string v63, "com.android.window.flags.fullscreen_dim_flag"

    const-string v64, "com.android.window.flags.get_dimmer_on_closing"

    const-string v65, "com.android.window.flags.immersive_app_repositioning"

    const-string v66, "com.android.window.flags.insets_control_changed_item"

    const-string v67, "com.android.window.flags.insets_control_seq"

    const-string v68, "com.android.window.flags.insets_decoupled_configuration"

    const-string v69, "com.android.window.flags.introduce_smoother_dimmer"

    const-string v70, "com.android.window.flags.keyguard_appear_transition"

    const-string v71, "com.android.window.flags.letterbox_background_wallpaper"

    const-string v72, "com.android.window.flags.movable_cutout_configuration"

    const-string v73, "com.android.window.flags.move_animation_options_to_change"

    const-string v74, "com.android.window.flags.multi_crop"

    const-string v75, "com.android.window.flags.nav_bar_transparent_by_default"

    const-string v76, "com.android.window.flags.no_consecutive_visibility_events"

    const-string v77, "com.android.window.flags.no_visibility_event_on_display_state_change"

    const-string v78, "com.android.window.flags.offload_color_extraction"

    const-string v79, "com.android.window.flags.predictive_back_system_anims"

    const-string v80, "com.android.window.flags.rear_display_disable_force_desktop_system_decorations"

    const-string v81, "com.android.window.flags.release_snapshot_aggressively"

    const-string v82, "com.android.window.flags.remove_prepare_surface_in_placement"

    const-string v83, "com.android.window.flags.screen_recording_callbacks"

    const-string v84, "com.android.window.flags.sdk_desired_present_time"

    const-string v85, "com.android.window.flags.secure_window_state"

    const-string v86, "com.android.window.flags.set_sc_properties_in_client"

    const-string v87, "com.android.window.flags.skip_sleeping_when_switching_display"

    const-string v88, "com.android.window.flags.supports_multi_instance_system_ui"

    const-string v89, "com.android.window.flags.surface_control_input_receiver"

    const-string v90, "com.android.window.flags.surface_trusted_overlay"

    const-string v91, "com.android.window.flags.sync_screen_capture"

    const-string v92, "com.android.window.flags.task_fragment_system_organizer_flag"

    const-string v93, "com.android.window.flags.transit_ready_tracking"

    const-string v94, "com.android.window.flags.trusted_presentation_listener_for_window"

    const-string v95, "com.android.window.flags.untrusted_embedding_any_app_permission"

    const-string v96, "com.android.window.flags.untrusted_embedding_state_sharing"

    const-string v97, "com.android.window.flags.use_window_original_touchable_region_when_magnification_recompute_bounds"

    const-string v98, "com.android.window.flags.user_min_aspect_ratio_app_default"

    const-string v99, "com.android.window.flags.wait_for_transition_on_display_switch"

    const-string v100, "com.android.window.flags.wallpaper_offset_async"
