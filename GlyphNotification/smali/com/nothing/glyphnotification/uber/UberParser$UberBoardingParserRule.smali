.class public final Lcom/nothing/glyphnotification/uber/UberParser$UberBoardingParserRule;
...
.method public updateGlyphResult(Lcom/nothing/glyphnotification/GlyphNotification;Landroid/content/Context;)I
    ...
    const-string v0, "hcv_supply_selection_etd"

    invoke-virtual {p0, p2, v0, p1}, Lcom/nothing/glyphnotification/uber/UberParser$UberBoardingParserRule;->isMatchRegexString(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_0

    const-string v0, "notification_trip_enroute_title"

    .line 152
    invoke-virtual {p0, p2, v0, p1}, Lcom/nothing/glyphnotification/uber/UberParser$UberBoardingParserRule;->isContainsString(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_0

    const-string v0, "ub__etd_dropoff"
    ...
    .line 154
    :cond_0
    invoke-virtual {p0}, Lcom/nothing/glyphnotification/uber/UberParser$UberBoardingParserRule;->getGlyphResult()Lcom/nothing/glyphnotification/GlyphResult;
